...
<main>
  ...
  <SvelteEditTable  json_data={json_data} container_id="container1"  table_width="500px" />
  <br/>
  <SvelteEditTable  json_data={json_data2} container_id="container2"  table_width="500px" />
  <br/>
  <SvelteEditTable  json_data={json_data3} container_id="container3"  table_width="500px" />
  <br/>

  <div class="scroll-table-wrapper">
  <SvelteEditTable  json_data={json_data4} container_id="container4"   table_width="400%" scrollable=true/>
  </div>
  <br/>

  <div class="scroll-table-wrapper">
  <SvelteEditTable  json_data={json_data5} container_id="container5"   table_width="400%" scrollable=true/>
  </div>
  <br/>
