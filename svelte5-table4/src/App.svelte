...
<main>
  ...
  <p>table1</p>
  <SvelteEditTable  json_data={data1} container_id="container1"   table_width="500px" bind:this={table1} />
  
  <p>table2</p>
  <SvelteEditTable  json_data={data2} container_id="container2"  table_width="500px" bind:this={table2} />
  
  <p>table3</p>
  <SvelteEditTable  json_data={data3} container_id="container3"  table_width="500px" bind:this={table3} />
  
  <p>table4</p>
  <div class="scroll-table-wrapper">
  <SvelteEditTable  json_data={data4} container_id="container4"   table_width="400%" scrollable=true bind:this={table4} />
  </div>

  <p>table5</p>
  <div class="scroll-table-wrapper">
  <SvelteEditTable  json_data={data5} container_id="container5"   table_width="400%" scrollable=true bind:this={table5} />
  </div>

  <p>table6</p>
  <div class="scroll-table-wrapper">
  <SvelteEditTable  json_data={data5} container_id="container6"   table_width="400%" scrollable=true bind:this={table6} />
  </div>
